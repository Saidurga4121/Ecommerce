package com.testing.actiondriver;
import java.io.File;
...
import com.testing.actionInterface.ActionInterface;
...
//		}
	...
	// durga
	public  boolean switchToRightWindow(String windowTitle)
	{
		boolean flag = false;
		try {
			...
			{
				WebDriver window=driver.switchTo().window(i);
	...
	public boolean switchToNewWindow(WebDriver driver) {
		boolean flag = false;
		try {
			Set<String> s=driver.getWindowHandles();  // [parent,child]
	...
	public static String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "http://localhost:8082/job/Ecommerce/ws/Ecommerce/ScreenShots/" + filename + "_"
				+ dateName + ".png";
